        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1">ONLINE FOOD DELIVERY</a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                      ...
                      <div class="row">
                        <div class="input-field col s12">
							...
							<select id="payment_type" name="payment_type">
									<option value="Wallet" selected>Credit card</option>
